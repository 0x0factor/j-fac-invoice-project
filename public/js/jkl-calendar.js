...
JKL.Calendar.Style.prototype.frame_color = "#8C4847"; // フレーム枠の色
...
JKL.Calendar.Style.prototype.month_hover_color = "#8C4847"; // マウスオーバー時の≪≫文字色
JKL.Calendar.Style.prototype.month_hover_bgcolor = "#FFFFCC"; // マウスオーバー時の≪≫背景色
JKL.Calendar.Style.prototype.weekday_color = "#8C4847"; // 月曜～金曜日セルの文字色
...
JKL.Calendar.prototype.setFormValue = function (ymd) {
    ...
    $('input[name="' + this.valname + '"]').val(ymd);
    var form1 = this.getFormElement();
    if (form1) {
        form1.value = ymd;
        form1.style.color = "#000";
    }
};
...
JKL.Calendar.prototype.write = function () {
    ...
    if (this.max_date) {
        var tmp = new Date(
            ...
            this.max_date.getMonth(),
            this.max_date.getDate()
        );
        max = tmp.getTime();
    }
    ...
    week_table_style +=
        "border-left: 1px solid " + this.style.frame_color + "; ";
    week_table_style +=
        "border-right: 1px solid " + this.style.frame_color + "; ";
    ...
    src1 +=
        '<td id="__' +
        this.eid +
        '_btn_close" title="閉じる" style="' +
        month_td_style +
        '">×</td>';
    src1 +=
        '<td id="__' +
        this.eid +
        '_btn_next" title="次の月へ" style="' +
        month_td_style +
        '">≫</td>';
    src1 += "</tr></table>\n";
    src1 +=
    ...
    src1 +=
        '<td style="color: ' +
        this.style.saturday_color +
        "; " +
        week_td_style +
        '">土</td>';
    src1 +=
        '<td style="color: ' +
        this.style.sunday_color +
        "; " +
        week_td_style +
        '">日</td>';
    src1 += "</tr></table>\n";
    ...
    // document.getElementById('cal1').style.top = $('.cal').position().top + $('.cal').height() + 8 + 'px';
    ...
    $(window).resize(function () {
        cal1.style.top =
            $(".cal").position().top + $(".cal").height() + 8 + "px";
        cal1.style.left = $(".cal").position().left + "px";
    });
...
// 旧バージョン互換（typo）
JKL.Calendar.prototype.getCalenderElement =
    JKL.Calendar.prototype.getCalendarElement;
