        ...
        if (
            ...
            for (x = f.length; o < x; o++) {
                ...
                for (k = 0; k < J.length; k++) {
                    h = J[k];
                    if (
                        r.selector === h.selector &&
                        (!A || A.test(h.namespace))
                    ) {
                        l = r.elem;
                        e = null;
                        if (
                            h.preType === "mouseenter" ||
        ...
        c = (function () {
            ...
            b.extend({
                    ...
                    if (!b.readyWait || (j !== true && !b.isReady)) {
                        ...
                        if (!(j !== true && --b.readyWait > 0))
                            if (q) {
                                ...
                                b.fn.trigger &&
                                    b(t).trigger("ready").unbind("ready");
                            }
                    }
                },
                bindReady: function () {
                ...
                parseJSON: function (j) {
                    ...
                    j = b.trim(j);
                    if (
                        C.test(j.replace(J, "@").replace(w, "]").replace(I, ""))
                    )
    ...
    c.fn.extend({
        ...
        addClass: function (a) {
            ...
            if (a && typeof a === "string")
                for (
                    var b = (a || "").split(ha), d = 0, e = this.length;
                    d < e;
                    d++
                ) {
                    var f = this[d];
        ...
        var k = function (g, i, n, m) {
            ...
            if (D.length > 1 && x.exec(g))
                if (D.length === 2 && o.relative[D[0]]) u = L(D[0] + D[1], i);
                    ...
                    for (
                        u = o.relative[D[0]] ? [i] : k(D.shift(), i);
                        D.length;
                ...
                preFilter: {
                    ...
                    PSEUDO: function (g, i, n, m, p) {
                        if (g[1] === "not")
                            ...
                            o.match.POS.test(g[0]) ||
                            o.match.CHILD.test(g[0])
                        )
                            return true;
                        return g;
                    },
        ...
        t.querySelectorAll &&
            (function () {
                ...
                if (
                    !(
                        i.querySelectorAll &&
                        i.querySelectorAll(".TEST").length === 0
                    )
                ) {
                    k = function (m, p, q, u) {
                        p = p || t;
            ...
            if (
                ...
                if (g.getElementsByClassName("e").length !== 1) {
                    ...
                    o.find.CLASS = function (i, n, m) {
                        if (
                            typeof n.getElementsByClassName !== "undefined" &&
                            !m
                        )
                        ...
                        d.call(
                            b
                                ? c.nodeName(this[f], "table")
                                    ? this[f].getElementsByTagName(
                                          "tbody"
                                      )[0] ||
                                      this[f].appendChild(
                                          this[f].ownerDocument.createElement(
                                              "tbody"
                                          )
                                      )
                                    : this[f]
            ...
            if (d)
                for (h = 0; f[h]; h++)
                    if (
                        ...
                        (!f[h].type ||
                            f[h].type.toLowerCase() === "text/javascript")
                    )
                        e.push(
                            f[h].parentNode
                        ...
                        f[h].nodeType === 1 &&
                            f.splice.apply(
                                ...
                                [h + 1, 0].concat(
                                    c.makeArray(
                                        f[h].getElementsByTagName("script")
                                    )
                                )
                            );
                        d.appendChild(f[h]);
                ...
                complete: function (l, k) {
                    if (k === "success" || k === "notmodified")
                        h.html(
                            f
                                ? c("<div>")
                                      .append(l.responseText.replace(nb, ""))
                                      .find(f)
                                : l.responseText
                        );
