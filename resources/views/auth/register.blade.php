            ...
            <div class="card-body">
                ...
                <form class="needs-validation" novalidate action="/register" method="POST">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" name="LOGIN_ID" class="form-control @error('name') is-invalid @enderror"
                            placeholder="LOGIN_ID" value="{{ old('LOGIN_ID') }}" required>
                    ...
                    <div class="input-group mb-3">
                        <input type="email" name="MAIL" class="form-control @error('email') is-invalid @enderror"
