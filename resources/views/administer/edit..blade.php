            ...
            <div class="contents_box">
                ...
                <div class="contents_area">
                    ...
                    <table width="880" cellpadding="0" cellspacing="0" border="0">
                            ...
                            <td style="width:710px;">
                                <select name="AUTHORITY" class="{{ $errors->has('AUTHORITY') ? 'error' : '' }}">
                                    @foreach ($authority as $key => $value)
                                        <option value="{{ $key }}"
                                            {{ old('AUTHORITY') == $key ? 'selected' : '' }}>{{ $value }}</option>
                                    @endforeach
                                </select>
                                @error('AUTHORITY')
                                    <span class="must">{{ $message }}</span>
                        ...
                        <tr>
                            ...
                            <td style="width:710px;">
                                <input type="text" name="LOGIN_ID" value="{{ old('LOGIN_ID') }}"
                                    class="w300 {{ $errors->has('LOGIN_ID') || $error['LOGIN_ID'] == 1 ? 'error' : '' }}"
                                    maxlength="10">
                        ...
                        <tr>
                            <td colspan="2">
                                <input type="radio" name="CHANGEFLG" value="0"
                                    class="ml20 mr5 txt_mid">パスワードを変更しない
                                <input type="radio" name="CHANGEFLG" value="1"
                                    class="ml20 mr5 txt_mid">パスワードを変更する
                            </td>
                        </tr>

                        <tr>
                            <td colspan="2" class="line">
                                <div class="ps_class"><img src="{{ asset('img/i_line_solid.gif') }}" alt="">
                                </div>
                            </td>
                        </tr>
                        <tr>
