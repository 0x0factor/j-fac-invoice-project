                ...
                <div class="contents_area">
                    <table width="880" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            ...
                            <td style="width:750px;">
                                <input type="text" name="ITEM" value="{{ old('ITEM') }}"
                                    class="w300{{ $errors->has('ITEM') ? ' error' : '' }}" maxlength="80">
                        ...
                        <tr>
                            ...
                            <td style="width:750px;">
                                <input type="text" name="ITEM_KANA" value="{{ old('ITEM_KANA') }}"
                                    class="w300{{ $errors->has('ITEM_KANA') ? ' error' : '' }}" maxlength="50">
                        ...
                        <tr>
                            ...
                            <td style="width:750px;">
                                <input type="text" name="ITEM_CODE" value="{{ old('ITEM_CODE') }}"
                                    class="w300{{ $errors->has('ITEM_CODE') ? ' error' : '' }}" maxlength="8">
                        ...
                        <tr>
                            ...
                            <td style="width:750px;">
                                <input type="text" name="UNIT" value="{{ old('UNIT') }}"
                                    class="w300{{ $errors->has('UNIT') ? ' error' : '' }}" maxlength="8">
                        ...
                        <tr>
                            ...
                            <td style="width:750px;">
                                <input type="text" name="UNIT_PRICE" value="{{ old('UNIT_PRICE') }}"
                                    class="w300{{ $errors->has('UNIT_PRICE') ? ' error' : '' }}" maxlength="9">
                            ...
                            <td style="width:750px;">
                                ...
                                @if (is_array($excises) && !empty($excises))
                                    @foreach ($excises as $value => $label)
                                        <label>
                                            <input type="radio" name="TAX_CLASS" value="{{ $value }}"
                                                {{ old('TAX_CLASS') == $value ? 'checked' : '' }}>
                                            {{ $label }}
                                        </label>
                                        @if (!$loop->last)
                                            <br>
