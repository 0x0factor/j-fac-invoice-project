    ...
    <h3>
        <div class="edit_01" align="right">
            ...
            <span class="show_bt1_on">
                <img src="{{ asset('img/button/hide.png') }}" class="imgover" alt="on" onclick="return edit1_toggle('on');">
            </span>
        ...
        <div class="contents_area">
            <table width="880" cellpadding="0" cellspacing="0" border="0">
                <tr>
                    ...
                    <td width="320">
                        <input type="text" name="DATE" class="w100 p2 date cal{{ $errors->has('DATE') ? ' error' : '' }}" readonly value="{{ old('DATE') }}">
                ...
                <tr><td colspan="4" class="line"><img src="{{ asset('img/i_line_solid.gif') }}" alt=""></td></tr>
                ...
                <tr>
                    ...
                    <td id="SETCUSTOMER" style="width:270px;">
                        <input type="text" name="CUSTOMER_NAME" class="w130{{ $errors->has('CST_ID') ? ' error' : '' }}" readonly value="{{ old('CUSTOMER_NAME') }}">
                    ...
                    <td style="width:270px;" id="SETCUSTOMERCHARGE">
                        <input type="text" name="CUSTOMER_CHARGE_NAME" class="w120 p2{{ $errors->has('CHRC_ID') ? ' error' : '' }}" maxlength="30" readonly value="{{ old('CUSTOMER_CHARGE_NAME') }}">
                ...
                <tr>
                    ...
                    <td style="width:270px;" id="SETCHARGE" colspan="3">
                        <input type="text" name="CHARGE_NAME" class="w120 p2{{ $errors->has('CHR_ID') ? ' error' : '' }}" maxlength="30" readonly value="{{ old('CHARGE_NAME') }}">
        ...
        setInterval(function () {
            ...
            if (lastDate !== date) {
                ...
                if (calcDate.getFullYear() >= 2024 || (calcDate.getFullYear() >= 2023 && calcDate.getMonth() >= 9)) {
                    document.getElementById('{{ $formType }}TAXFRACTIONTIMING1').setAttribute('disabled', true);
                    document.getElementById('{{ $formType }}TAXFRACTIONTIMING0').click();
                } else {
                    document.getElementById('{{ $formType }}TAXFRACTIONTIMING1').removeAttribute('disabled');
                }
            }
        }, 1000);
    });
