	...
	<div class="contents_box">
		...
		<form action="{{ route('mail.store') }}" method="post">
			...
			<div class="contents_area">
				...
				<p class="p_message">{{ $rcv_name }} 様宛てに {{ $snd_name }} 様より下記データが届いています。<br>ダウンロードボタンを押してデータをダウンロードしてください。</p>
				...
				<div class="mail_table2">
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<tr>
							...
							<td width="130">
								<a href="{{ route($type . '.pdf', ['frm_id' => $frm_id, 'download' => 'download', 'token' => $token]) }}">
