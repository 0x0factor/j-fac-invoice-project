                        ...
                        <tr>
                            ...
                            <td style="width:750px;">
                                <input type="text" name="NAME_KANA"
                                    class="w300{{ $errors->has('NAME_KANA') ? ' error' : '' }}" maxlength="100"
                                    value="{{ old('NAME_KANA') }}">
                ...
                <table width="880" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr>
                        ...
                        <td style="width:750px;">
                            ...
                            <input type="text" name="CUTOOFF_DATE"
                                class="w60 mr5 ml5{{ $errors->has('CUTOOFF_DATE') ? ' error' : '' }}" maxlength="2"
                                value="{{ old('CUTOOFF_DATE') }}">日
