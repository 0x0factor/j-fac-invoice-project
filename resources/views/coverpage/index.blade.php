    ...
    <form action="{{ route('coverpage.store') }}" method="POST" class="Coverpages">
        ...
        <div class="contents_box">
            ...
            <div class="contents_area">
                ...
                <table width="880" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr>
                        ...
                        <td style="width:710px;" colspan="3" id="SETCUSTOMER">
                            <input type="text" name="CUSTOMER_NAME" value="{{ old('CUSTOMER_NAME') }}" class="w140 p2{{ $errors->has('CUSTOMER_NAME') ? ' error' : '' }}" maxlength="60" readonly>
                    ...
                    <tr>
                        ...
                        <td style="width:270px;" id="SETCUSTOMERCHARGE">
                            <input type="text" name="CUSTOMER_CHARGE_NAME" value="{{ old('CUSTOMER_CHARGE_NAME') }}" class="w120 p2{{ $errors->has('CUSTOMER_CHARGE_NAME') ? ' error' : '' }}" maxlength="60">
                        ...
                        <td style="width:270px;" id="SETCCUNIT">
                            <input type="text" name="CUSTOMER_CHARGE_UNIT" value="{{ old('CUSTOMER_CHARGE_UNIT') }}" class="w180 p2{{ $errors->has('CUSTOMER_CHARGE_UNIT') ? ' error' : '' }}" maxlength="60">
                            <br><span class="must">{{ $errors->first('CUSTOMER_CHARGE_UNIT') }}</span>
                        </td>
                    </tr>
                    <tr><td></td><td colspan="3"><br><span class="usernavi">{{ $usernavi['CVR_CST_CHR'] }}</span></td></tr>
                    <tr><td colspan="4"><img src="{{ asset('img/i_line_solid.gif') }}" alt="Line"></td></tr>
                    <tr>
                        <th style="width:170px;">自社担当者名</th>
                        <td style="width:710px;" colspan="3" id="SETCHARGE">
                            <input type="text" name="CHARGE_NAME" value="{{ old('CHARGE_NAME') }}" class="w180 p2{{ $errors->has('CHARGE_NAME') ? ' error' : '' }}" maxlength="60">
                    ...
                    <tr>
                        ...
                        <td colspan="4">
                            ...
                            <input type="text" name="DATE" value="{{ old('DATE') }}" class="w100 p2 date cal{{ $errors->has('DATE') ? ' error' : '' }}" readonly>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <input type="text" name="TITLE" value="{{ old('TITLE') }}" class="w180 p2{{ $errors->has('TITLE') ? ' error' : '' }}" maxlength="40">
                    ...
                    <table width="880" cellpadding="0" cellspacing="0" border="0">
                        <tbody>
                            ...
                            <tr class="row_{{ $i }}">
                                ...
                                <td style="width: 42px;">
                                    <img src="{{ asset('img/bt_delete.jpg') }}" alt="×" class="delbtn" onclick="return form.coverpage_delline({{ $i }});" />
                                </td>
                                <td style="width: 250px;">
                                    <input type="text" name="Reports[{{ $i }}][DOCUMENT_TITLE]" value="{{ old('Reports.'.$i.'.DOCUMENT_TITLE') }}"
                                        class="documenttitle{{ isset($document_error['DOCUMENT_TITLE']['NO'][$i]) ? ' error' : '' }}"
                                        style="width: 250px;" maxlength="30">
                                </td>
                                <td style="width: 100px;">
                                    <input type="text" name="Reports[{{ $i }}][DOCUMENT_NUMBER]" value="{{ old('Reports.'.$i.'.DOCUMENT_NUMBER') }}"
                ...
                <table width="880" cellpadding="0" cellspacing="0" border="0">
                    <tr><td colspan="5"><img src="{{ asset('img/i_line_solid.gif') }}" alt="Line"></td></tr>
                    <tr>
