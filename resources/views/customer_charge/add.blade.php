...
<div id="contents">
    ...
    <div class="contents_box">
        ...
        <div class="contents_area">
            <form action="{{ route('customer_charges.store') }}" method="post" class="CustomerCharge">
                @csrf
                <table width="880" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr><td colspan="2" class="line"><img src="{{ asset('i_line_solid.gif') }}" alt=""></td></tr>

                    <tr>
                        <th style="width:150px;">顧客名</th>
                        <td id="SETCUSTOMER" style="width:730px;">
                            <input type="text" name="CUSTOMER_NAME" value="{{ old('CUSTOMER_NAME') }}" readonly class="w130">
                    ...
                    <tr>
                        ...
                        <td style="width:730px;">
                            <input type="text" name="CHARGE_NAME" value="{{ old('CHARGE_NAME') }}" class="w300{{ $form->error('CHARGE_NAME') ? ' error' : '' }}" maxlength="60">
                            <br>
                    ...
                    <tr>
                        ...
                        <td style="width:730px;">
                            <input type="text" name="CHARGE_NAME_KANA" value="{{ old('CHARGE_NAME_KANA') }}" class="w300{{ $form->error('CHARGE_NAME_KANA') ? ' error' : '' }}" maxlength="60">
                            <br>
                    ...
                    <tr>
                        ...
                        <td style="width:730px;">
                            <input type="text" name="UNIT" value="{{ old('UNIT') }}" class="w300{{ $form->error('UNIT') ? ' error' : '' }}" maxlength="60">
                            <br>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="POST" value="{{ old('POST') }}" class="w300{{ $form->error('POST') ? ' error' : '' }}" maxlength="60">
                            <br>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="MAIL" value="{{ old('MAIL') }}" class="w300{{ $form->error('MAIL') ? ' error' : '' }}" maxlength="256">
                            <br>
                    ...
                    <tr>
                        <th style="width:150px;" class="{{ $form->error('POSTCODE1') || $form->error('POSTCODE2') ? 'txt_top' : '' }}">
                            <span class="float_l">郵便番号</span>
                        </th>
                        <td style="width:730px;">
                            <input type="text" name="POSTCODE1" value="{{ old('POSTCODE1') }}" class="w60{{ $form->error('POSTCODE1') || $form->error('POSTCODE2') ? ' error' : '' }}" maxlength="3">
                            <span class="pl5 pr5">-</span>
                            <input type="text" name="POSTCODE2" value="{{ old('POSTCODE2') }}" class="w60{{ $form->error('POSTCODE1') || $form->error('POSTCODE2') ? ' error' : '' }}" maxlength="4">
                            <div id="target"></div>
                            <br>
                    ...
                    <tr>
                        <th style="width:150px;" class="{{ $form->error('ADDRESS') ? 'txt_top' : '' }}"><span class="float_l">住所</span></th>
                        <td style="width:730px;">
                            <input type="text" name="ADDRESS" value="{{ old('ADDRESS') }}" class="w600{{ $form->error('ADDRESS') ? ' error' : '' }}" maxlength="100">
                            <br>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="BUILDING" value="{{ old('BUILDING') }}" class="w600{{ $form->error('BUILDING') ? ' error' : '' }}" maxlength="100">
                            <br>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="FAX_NO1" value="{{ old('FAX_NO1') }}" class="w60{{ $ferror == 1 ? ' error' : '' }}" maxlength="4">
                            <span class="pl5 pr5">-</span>
                            <input type="text" name="FAX_NO2" value="{{ old('FAX_NO2') }}" class="w60{{ $ferror == 1 ? ' error' : '' }}" maxlength="4">
                            <span class="pl5 pr5">-</span>
                            <input type="text" name="FAX_NO3" value="{{ old('FAX_NO3') }}" class="w60{{ $ferror == 1 ? ' error' : '' }}" maxlength="4">
                            <br>
