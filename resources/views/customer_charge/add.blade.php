...
@section('content')
    ...
    <div id="contents">
        <form action="{{ route('customer_charge.add') }}" method="POST" class="CustomerCharge">
            ...
            <h3>
                <div class="img/edit_01_c_charge"><span class="edit_txt">&nbsp;</span></div>
            </h3>
                            ...
                            <tr>
                                ...
                                <td id="SETCUSTOMER" style="width:730px;">
                                    ...
                                    <a href="#" onclick="return popupclass.popupajax('select_customer');">
                                        <img src="{{ asset('img/bt_registered.jpg') }}" alt="" class="imgover">
                                    </a>
                                    <a href="#" onclick="return customer_reset();">
                                        <img src="{{ asset('img/bt_reset.jpg') }}" alt="" class="imgover">
                                    </a>
                                    <br>
