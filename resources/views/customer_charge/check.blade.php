...
<div id="contents">
    ...
    <div class="edit_btn2">
        @if($editauth)
            <a href="{{ url('customer_charges/edit/' . $chrcID) }}" class="imgover" onclick="return confirm('Are you sure you want to edit?')">
    ...
    <div class="contents_box">
        ...
        <div class="contents_area">
            <table width="880" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr><td colspan="2" class="line"><img src="{{ asset('img/i_line_solid.gif') }}" alt="Line Image"></td></tr>
                ...
                <tr>
                    <th>電話番号</th>
                    <td>
                        @if(!empty($CustomerCharge['PHONE_NO1']) && !empty($CustomerCharge['PHONE_NO2']) && !empty($CustomerCharge['PHONE_NO3']))
