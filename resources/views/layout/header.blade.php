    ...
    <div id="header" class="clearfix">
        ...
        <div>
            <ul id="menu" class="menu">
                ...
                @endif
                <li>
                    @if (preg_match('/^quotes|^bills|^totalbills|^regularbill|^deliveries|^mails|^customers\/select/', $routeName) ||
                            $plugin == 'regularbill')
                    ...
                    <ul class="dmenu">
                        ...
                        <li><span><a href="{{ route('quote.movetoindex') }}">見積書一覧</a></span></li>
                        <li><span><a href="{{ route('quote.add') }}">見積書を作成する</a></span></li>
                        <li class="line">"><img src="{{ asset('/img/i_line_dmenu.gif') }}"></li>
                        <li><span><a href="{{ route('bill.movetoindex') }}">請求書一覧</a></span></li>
                        <li><span><a href="{{ route('bill.add') }}">請求書を作成する</a></span></li>
                        <li><span><a href="{{ route('totalbill.movetoindex') }}">合計請求書一覧</a></span></li>
                        <li class="line">"><img src="{{ asset('/img/i_line_dmenu.gif') }}"></li>
                        <li><span><a href="{{ route('deliverie.movetoindex') }}">納品書一覧</a></span></li>
                        <li><span><a href="{{ route('deliverie.add') }}">納品書を作成する</a></span></li>
                        <li class="line">"><img src="{{ asset('/img/i_line_dmenu.gif') }}"></li>
                ...
                <li>
                    ...
                    @if (isset($user) && $user['AUTHORITY'] == 0)
                        ...
                        @endif
                        <ul class="dmenu">
                            <li><span><a href="{{ route('administer.movetoindex') }}">ユーザを管理する</a></span></li>
                            <li><span><a href="{{ route('historie.movetoindex') }}">操作履歴を見る</a></span></li>
