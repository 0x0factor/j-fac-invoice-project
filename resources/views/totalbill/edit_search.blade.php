                    ...
                    <table width="600" cellpadding="0" cellspacing="0" border="0">
                        ...
                        <tr>
                            ...
                            <td width="320">
                                ...
                                <input type="text" name="data[{{$formType}}][FROM]" id="FROM" class="w100 p2 date cal" readonly
                        ...
                        <form action="{{ url('totalbills/edit') }}" method="POST" class="Totalbill">
                            ...
                            <table width="900" cellpadding="0" cellspacing="0" border="0">
                                ...
                                @foreach ($billlist as $i => $val)
                                    <tr>
                                        <td>
                                            <input type="checkbox" name="MBL_ID[]" value="{{ $val['Bill']['MBL_ID'] }}"
                                                class="chk" id="check_{{ $i }}"
                                                {{ isset($val['Bill']['CHK']) ? 'checked' : '' }}>
                                        </td>
                                        <td>{{ $val['Bill']['NO'] ?? '　' }}</td>
