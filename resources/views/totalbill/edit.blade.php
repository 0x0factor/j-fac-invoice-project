                ...
                <div class="contents_area">
                    <table width="880" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            ...
                            <td width="320">
                                <input type="text" name="NO" value="{{ old('NO', $totalbill->NO) }}"
                        ...
                        <tr>
                            <th class="{{ $errors->has('SUBJECT') ? 'txt_top' : '' }}"><span class="float_l">件名</span><img
                                    src="{{ asset('img/i_must.jpg') }}" alt="必須" class="pl10 mr10 float_r"></th>
                            <td colspan="3">
                                <input type="text" name="SUBJECT" value="{{ old('SUBJECT', $totalbill->SUBJECT) }}"
                        ...
                        <tr>
                            <td colspan="4" class="line"><img src="{{ asset('img/i_line_solid.gif') }}"
                                    alt="Line"></td>
                        </tr>
                        <tr>
                            <th class="{{ $errors->has('CST_ID') ? 'txt_top' : '' }}"><span class="float_l">顧客名</span><img
                                    src="{{ asset('img/i_must.jpg') }}" alt="必須" class="pl10 mr10 float_r"></th>
                            <td id="SETCUSTOMER" colspan="3">
                                <input type="text" name="CUSTOMER_NAME"
                                    value="{{ old('CUSTOMER_NAME', $totalbill->CUSTOMER_NAME) }}"
                                ...
                                <a href="#" onclick="return popupclass.popupajax('select_customer');"><img
                                        src="{{ asset('img/bt_select2.jpg') }}" alt="Select"></a>
                                <a href="#" onclick="return customer_reset();"><img
                                        src="{{ asset('img/bt_delete2.jpg') }}" alt="Delete"></a>
                        ...
                        <tr>
                            ...
                            <td style="width:270px;" id="SETCUSTOMERCHARGE">
                                <input type="text" name="CUSTOMER_CHARGE_NAME"
                                    value="{{ old('CUSTOMER_CHARGE_NAME', $totalbill->CUSTOMER_CHARGE_NAME) }}"
                            ...
                            <td style="width:270px;" id="SETCCUNIT">
                                <input type="text" name="CUSTOMER_CHARGE_UNIT"
                                    value="{{ old('CUSTOMER_CHARGE_UNIT', $totalbill->CUSTOMER_CHARGE_UNIT) }}"
                                    class="w180 p2 {{ isset($error['CUSTOMER_CHARGE_UNIT']) ? 'error' : '' }}" readonly>
                        ...
                        <tr>
                            <th class="{{ $errors->has('HONOR_TITLE') ? 'txt_top' : '' }}"><span
                                    class="float_l">敬称</span></th>
                            <td id="HONOR" colspan="3">
                                @foreach ($honor as $key => $value)
                                    <label class="ml20 mr5 txt_mid">
                                        <input type="radio" name="HONOR_CODE" value="{{ $key }}"
                                            {{ old('HONOR_CODE', $totalbill->HONOR_CODE) == $key ? 'checked' : '' }}>
                                        {{ $value }}
                                    </label>
                                @endforeach
                                <input type="text" name="HONOR_TITLE"
                                    value="{{ old('HONOR_TITLE', $totalbill->HONOR_TITLE) }}"
                        ...
                        <tr>
                            <th class="{{ $errors->has('MEMO') ? 'txt_top' : '' }}"><span class="float_l">備考</span><img
                                    src="{{ asset('img/i_must.jpg') }}" alt="必須" class="pl10 mr10 float_r"></th>
                            <td colspan="3">
                                <textarea name="MEMO" class="w750 p3 {{ $errors->has('MEMO') ? 'error' : '' }}" rows="8"
                                    onkeyup="count_str('memo_rest', value, 100)">{{ old('MEMO', $totalbill->MEMO) }}</textarea>
                        ...
                        <tr>
                            <td colspan="4" class="center"><input type="image"
                                    src="{{ asset('img/bt_save.jpg') }}" alt="保存する" class="btn_save"></td>
                        </tr>
                    </table>
                </div>
