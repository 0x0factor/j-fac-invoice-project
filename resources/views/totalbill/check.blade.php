            ...
            <div class="contents_area">
                <table width="880" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            {{ isset($param['CustomerCharge']['CHARGE_NAME']) ? $customHtml->ht2br($param['CustomerCharge']['CHARGE_NAME'], 'CustomerCharge', 'CHARGE_NAME') : '' }}
                        </td>
                    </tr>
                    <tr>
                        <td colspan="4" class="line">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            {{ isset($param['CustomerCharge']['UNIT']) ? $customHtml->ht2br($param['CustomerCharge']['UNIT'], 'CustomerCharge', 'UNIT') : '' }}
                        </td>
                    </tr>
                    <tr>
                        <td colspan="4">
                    ...
                    <tr>
                        ...
                        <td colspan="3">{{ $customHtml->ht2br($param['Totalbill']['DUE_DATE'], 'Bill', 'DUE_DATE') }}
                        </td>
                    </tr>
                </table>
            </div>
                        ...
                        <table width="900" cellpadding="0" cellspacing="0" border="0">
                            ...
                            @foreach ($param['Bill'] as $key => $val)
                                <tr>
                                    ...
                                    <td>{{ $customHtml->ht2br($val['Bill']['ISSUE_DATE'], 'Totalbill', 'ISSUE_DATE') }}
                                    </td>
                                    <td>{{ $customHtml->ht2br($val['Bill']['DUE_DATE'] ?? '　', 'Totalbill', 'DUE_DATE') }}
                                    </td>
                                    <td id="TOTAL{{ $loop->index }}">
                                        {{ $customHtml->ht2br($val['Bill']['TOTAL'] ?? '　', 'Totalbill', 'TOTAL') }}</td>
                                    <div id="tax{{ $loop->index }}" style="display:none;">
                                        {{ $customHtml->ht2br($val['Bill']['SALES_TAX']) }}</div>
                                    <div id="subtotal{{ $loop->index }}" style="display:none;">
                                        {{ $customHtml->ht2br($val['Bill']['SUBTOTAL']) }}</div>
                                </tr>
                            @endforeach
                        </table>
                    @endif
