...
<div id="contents">
    <form action="{{ action('TotalbillController@add') }}" method="POST" class="Totalbill">
            ...
            <div class="contents_area">
                <table width="880" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        ...
                        <td width="320">
                            <input type="text" name="NO" value="{{ old('NO') }}" class="w180 p2{{ $errors->has('NO') ? ' error' : '' }}" maxlength="20">
                            <br><span class="usernavi">{{ $usernavi['NO'] }}</span>
                            <br><span class="must">{{ $errors->first('NO') }}</span>
                        </td>
                        <th>発行日</th>
                        <td width="320">
                            <input type="text" name="DATE" value="{{ old('DATE') }}" class="w100 p2 date cal{{ $errors->has('DATE') ? ' error' : '' }}" readonly onchange="cal1.getFormValue(); cal1.hide();">
                    ...
                    <tr>
                        <td colspan="3"></td>
                        <td><span class="usernavi">{{ $usernavi['DATE'] }}</span><br><span class="must">{{ $errors->first('ISSUE_DATE') }}</span></td>
                    </tr>
                    <tr><td colspan="4"><img src="{{ asset('img/i_line_solid.gif') }}" alt=""></td></tr>
                    <tr>
                        <th>件名</th>
                        <td colspan="3">
                            <input type="text" name="SUBJECT" value="{{ old('SUBJECT') }}" class="w320 mr10{{ $errors->has('SUBJECT') ? ' error' : '' }}" maxlength="80" onkeyup="count_str('subject_rest', value, 40)">
                    ...
                    <tr>
                        ...
                        <td id="SETCUSTOMER" colspan="3">
                            <input type="text" name="CUSTOMER_NAME" value="{{ old('CUSTOMER_NAME') }}" class="w130{{ $errors->has('CST_ID') ? ' error' : '' }}" readonly>
                            <input type="hidden" name="CST_ID">
                            <a href="#" onclick="return popupclass.popupajax('select_customer');"><img src="{{ asset('img/bt_select2.jpg') }}" alt="選択"></a>
                            <a href="#" onclick="return customer_reset();"><img src="{{ asset('img/bt_delete2.jpg') }}" alt="削除"></a>
                    ...
                    <tr>
                        ...
                        <td id="SETCUSTOMERCHARGE" colspan="3">
                            <input type="text" name="CUSTOMER_CHARGE_NAME" value="{{ old('CUSTOMER_CHARGE_NAME') }}" class="w120 p2{{ isset($error['CUSTOMER_CHARGE_NAME']) ? ' error' : '' }}" readonly>
                            <input type="hidden" name="CHRC_ID">
                            <a href="#" onclick="return popupclass.popupajax('customer_charge');"><img src="{{ asset('img/bt_select2.jpg') }}" alt="選択"></a>
                            <a href="#" onclick="return cstchr_reset();"><img src="{{ asset('img/bt_delete2.jpg') }}" alt="削除"></a>
                            <br><span class="must">{{ isset($error['CUSTOMER_CHARGE_NAME']) ? $error['CUSTOMER_CHARGE_NAME'] : '' }}</span>
                        </td>
                    </tr>
                    <tr><td colspan="4"><img src="{{ asset('img/i_line_solid.gif') }}" alt=""></td></tr>
                    <tr>
                        ...
                        <td id="HONOR" colspan="3">
                            ...
                            @endforeach
                            <input type="text" name="HONOR_TITLE" value="{{ old('HONOR_TITLE') }}" class="w160 mr10{{ $errors->has('HONOR_TITLE') ? ' error' : '' }}" maxlength="8">
                    ...
                    <tr>
                        <th>振込期限</th>
                        <td colspan="3">
                            <input type="text" name="DUE_DATE" value="{{ old('DUE_DATE') }}" class="w320 mr10{{ $errors->has('DUE_DATE') ? ' error' : '' }}" maxlength="20" onkeyup="count_str('duedate_rest', value, 20)">
        ...
        <div class="contents_foot">
            ...
            <button type="button" onclick="return location.href='{{ action('TotalbillController@index') }}'" class="ml10">
