            ...
            <div class="popup_contents_area clearfix">
                <table width="440" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr class="popup_item_kana">
                        ...
                        <td style="width:310px;"><input type="text" name="ITEM_KANA" class="w300" maxlength="50">
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" class="line"><img src="{{ asset('/img/popup/i_line_solid.gif') }}"></td>
                    ...
                    <tr class="popup_item_code">
                        ...
                        <td style="width:310px;"><input type="text" name="ITEM_CODE" class="w300" maxlength="8">
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" class="line"><img src="{{ asset('/img/popup/i_line_solid.gif') }}"></td>
                    ...
                    <tr class="popup_unit">
                        ...
                        <td style="width:310px;"><input type="text" name="UNIT" class="w300" maxlength="8">
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" class="line"><img src="{{ asset('/img/popup/i_line_solid.gif') }}"></td>
                    ...
                    <tr class="popup_unitprice">
                        ...
                        <td style="width:310px;"><input type="text" name="UNIT_PRICE" class="w300" maxlength="8">
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" class="line"><img src="{{ asset('/img/popup/i_line_solid.gif') }}"></td>
                    ...
                    <tr>
                        ...
                        <td style="width:310px;">
                            <label><input type="radio" name="TAX_CLASS" value="2"
                                    @if ($TaxClass == 2) checked @endif> 外税</label>
                            <label><input type="radio" name="TAX_CLASS" value="1"
                                    @if ($TaxClass == 1) checked @endif> 内税</label>
                            <label><input type="radio" name="TAX_CLASS" value="3"
                                    @if ($TaxClass == 3) checked @endif> 非課税</label>
                        </td>
                    </tr>
                </table>
                <div class="save_btn">
