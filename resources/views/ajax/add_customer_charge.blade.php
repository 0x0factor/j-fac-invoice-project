            ...
            <div class="popup_contents_area clearfix">
                <table width="440" cellpadding="0" cellspacing="0" border="0">
                    <tr class="popup_cname">
                        <th style="width:130px;">担当者名<img src="{{ asset('img/i_must.jpg') }}" alt="必須" class="pl10" /></th>
                        <td style="width:310px;"><input type="text" name="CHARGE_NAME" class="w300" maxlength="60"></td>
                    </tr>
                    ...
                    <tr class="popup_cunit">
                        ...
                        <td style="width:310px;"><input type="text" name="UNIT" class="w300" maxlength="60"></td>
                    </tr>
